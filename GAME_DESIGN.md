...
> custos, sorteio) + `data/legendaries.ts` (elenco de 12, 3 tiers, constantes §8) + store (recrutar/
...
> `cbrt`. tsc + 103 testes (13 domain + Corte na store + migração no save) + build verdes.
